...
class StripeService {
    ...
    try {
      ...
      if (paymentIntentData != null) {
        ...
        await Stripe.instance.initPaymentSheet(
          ...
          // applePay: const PaymentSheetApplePay(merchantCountryCode: '+55'),
          // googlePay: const PaymentSheetGooglePay(merchantCountryCode: '+55', testEnv: true),
  ...
  createPaymentIntent(String amount, String currency) async {
    try {
      ...
      var response =
          await http.post(Uri.parse(ApiConfig.stripeUrl), body: body, headers: {
